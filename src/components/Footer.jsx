    ...
    <div className='flex flex-col justify-center items-center w-full py-20'>
      ...
      <div className='flex flex-row pt-15 gap-15'>
        <div className='flex flex-col'>
            ...
            <p className='font-poppins font-normal text-[#5F5F5F] pt-4 text-[15px] w-100'>Transforming Your familiy Dental care experience with our comprehensive one-stop solutions!</p>
        ...
        <div className='flex flex-row gap-17 pt-17'>
       ...
       <hr className='border-[1px] border-[#D0D0D0] w-269 my-10'/>
       <div className='flex flex-row gap-62'>
        ...
        <div className='flex flex-row gap-17'>
          ...
          <div className='flex flex-col gap-2.5'>
            ...
            <p className='font-poppins font-medium text-[14px] text-[#595959] w-70'>Ruko Pisa Grande B no 7, Paramount Boulevard, Tangerang, Banten 15810</p>
          </div>
        </div>
       </div>
    </div>
